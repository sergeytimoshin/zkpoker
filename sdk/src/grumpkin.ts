 ...
 */
export function scalarFromBigint(value: bigint): Scalar {
 ...
 */
export function mod(n: bigint, p: bigint = FIELD_MODULUS): bigint {
  const result = n % p;
 ...
 */
export function modInverse(a: bigint, p: bigint = FIELD_MODULUS): bigint {
 ...
 */
export function pointAtInfinity(): Point {
 ...
 */
export function createPoint(x: bigint, y: bigint, validate = true): Point {
  if (x === 0n && y === 0n) {
    return pointAtInfinity();
  }

  const point: Point = { x: mod(x), y: mod(y), isInfinity: false };
 ...
 */
export function scalarMul(point: Point, scalar: Scalar): Point {
 ...
 */
export function fixedBaseScalarMul(scalar: Scalar): Point {
