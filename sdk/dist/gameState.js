 ...
 */
export function createGameState(stackP1, stackP2, dealer) {
    return {
        stackP1,
        stackP2,
        pot: 0,
 ...
 */
export function postBlinds(state, smallBlind, bigBlind) {
 ...
 */
export function gameStateCommitment(state) {
    return pedersenHash([
...
export function isValidAction(state, action) {
    ...
    switch (action.actionType) {
        ...
        case ACTION_BET:
            ...
            const canBet = state.lastAction === ACTION_NULL || state.lastAction === ACTION_CHECK;
...
export function applyAction(state, action) {
    ...
    // Update street bets
    let newStreetBetP1 = state.currentPlayer === 1
        ? state.streetBetP1 + chipsToAdd
        : state.streetBetP1;
    let newStreetBetP2 = state.currentPlayer === 2
 ...
 */
export function actionTypeName(actionType) {
    switch (actionType) {
        case ACTION_NULL:
            return "null";
        case ACTION_BET:
 ...
 * Get street name
 */
export function streetName(street) {
    switch (street) {
        case STREET_PREFLOP:
            return "preflop";
        case STREET_FLOP:
