...
export interface Card {
  epk: Point;  // Joint ephemeral public key from all masking operations
  msg: Point;  // Card value as a curve point (masked or unmasked)
  pk: Point;   // Joint public key of all players involved in masking
}

/**
 * Create a new unmasked card from a card point
 */
export function createCardFromPoint(cardPoint: Point): Card {
  return {
    epk: pointAtInfinity(),
    msg: cardPoint,
    pk: pointAtInfinity(),
 ...
 */
export function cardIndexToPoint(cardIndex: number): Point {
 ...
 */
export function createCard(cardIndex: number): Card {
 ...
 */
export function isUnmasked(card: Card): boolean {
 ...
 */
export function hasPlayers(card: Card): boolean {
  return !card.pk.isInfinity;
}
 ...
 */
export function hasEpk(card: Card): boolean {
 ...
 */
export function cardCommitment(card: Card): bigint {
