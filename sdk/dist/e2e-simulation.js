 ...
 */
import { createGameState, postBlinds, applyAction, generateGameActionProverToml, generateShuffleProverToml, randomPermutation, toHex, ACTION_CALL, ACTION_BET, ACTION_RAISE, ACTION_CHECK, } from './game-state.js';
import { addPlayerAndMask, partialUnmask, secretToPublicKey, randomScalar, } from './elgamal.js';
import { createCard, cardCommitment, } from './card.js';
...
class PokerSimulation {
    ...
    shuffleByPlayer(player, inputDeck) {
    ...
    generateUnmaskToml(player, cardPosition, inputCard, outputCard) {
...
`;
    ...
    executeAction(actionType, amount = 0) {
        const currentPlayer = this.players[this.gameState.currentPlayer - 1];
        const action = { actionType, amount };
        const actionNames = {
            1: 'BET',
            2: 'CALL',
            3: 'FOLD',
...
//# sourceMappingURL=e2e-simulation.js.map